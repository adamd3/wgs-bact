        ...
        SRA_FASTQ_FTP
            ...
            .map {
                meta, fastq ->
                    ...
                    meta_clone.fastq_1 = reads[0] ? "${params.outdir}/fastq/${reads[0].getName()}" : "stub_fastq_1.fastq.gz" // Provide a dummy name for stub
                    meta_clone.fastq_2 = reads[1] && !meta.single_end ? "${params.outdir}/fastq/${reads[1].getName()}" : "stub_fastq_2.fastq.gz" // Provide a dummy name for stub
